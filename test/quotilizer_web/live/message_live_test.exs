defmodule QuotilizerWeb.MessageLiveTest do
  use QuotilizerWeb.ConnCase

  import Phoenix.LiveViewTest

  alias Quotilizer.TwitchFeed

  @create_attrs %{text: "some text", username: "some username"}
  ...
  defp fixture(:message) do
    {:ok, message} = TwitchFeed.create_message(@create_attrs)
    message
  end
